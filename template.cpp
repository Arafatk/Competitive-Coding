...
template<class T1, class T2> T1 binpow(T1 number, T2 power) {
        T1 result = number; while(power) { if(power & 1) result = result*number; number = number*number; power /= 2;} return result;
}
